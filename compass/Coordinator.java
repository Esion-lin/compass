...
public class Coordinator {
  ...
  private boolean createAndBroadcastMilestone(String trunk, String branch) throws InterruptedException {
    ...
    */
    ...
    try{
      ...
      if(config.Mulitiple){
        ...
        /**  decode result **/
      /*add threshold sig*/
        latestMilestoneTransactions = db.createMilestone(trunk, branch, state.latestMilestoneIndex, config.MWM, result);
      }else{
        latestMilestoneTransactions = db.createMilestone(trunk, branch, state.latestMilestoneIndex, config.MWM);
      }
