...
/*    Transaction thresholdSignData = new Transaction();
    ...
    thresholdSignData.setCurrentIndex(signatureSource.getSecurity());
    thresholdSignData.setLastIndex(signatureSource.getSecurity());
    ...
    thresholdSignData.setTrunkTransaction(trunk);
    thresholdSignData.setBranchTransaction(branch);
